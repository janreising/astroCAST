...
\def\corrAuthor{Jan Philipp Reising, CMM Center for Molecular Medicine L8:05, 171 76 Stockholm, Sweden}
\def\corrEmail{jan.reising@ki.se}
...
%    \extraAuth{corresponding Author2 \\ Laboratory X2, Institute X2, Department X2, Organization X2, Street X2, City X2, State XX2 (only USA, Canada and Australia), Zip Code2, X2 Country X2, email2@uni2.edu}
    ...
    \section*{Funding}
    \todo{Eric}{ths?}{Still not sure if that means this section is okay or not!?}
