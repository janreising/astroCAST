...
\todo{Jan}{Include text or table which packages were used.}{
\begin{itemize}
    \item AquA
    \item CaImAn, jnormcorre
    \item scikit-image, scikit-learn,scipy
    \item shiny, napari
    \item dask, dask-image
    \item umap-learn, hdbscan
    \item dtaidistance
    \item matplotlib, seaborn
    \item tensorflow, pytorch
    \item deepinterpolation
\end{itemize}
}