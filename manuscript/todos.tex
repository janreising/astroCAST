...
\todo{Jan}{Last checks}{
    \begin{itemize}
        \item Update figures
        \item check word count, manuscript length and figure number (\href{https://www.frontiersin.org/journals/cellular-neuroscience/for-authors/article-types}{Methods article or Technology and Code})
        \begin{itemize}
            \item 12,000 words max
